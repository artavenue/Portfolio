---
title: "The Ultimate Chat Widget"
subtitle: "Building a native, flexible interface that turned an AI plugin into an all-in-one platform."
meta_label: "0→1 Product · Ultimate.ai"
hero_image: "/assets/images/ultimate/ultimate_chat_widget_video_size_optim.gif"
hero_bg: "linear-gradient(to right, #d4d1d4 0%, #e9e6e9 30%, #e9e6e9 70%, #d4d1d4 100%)"
hero_bg_wrap: true
---

- **Role:** Senior Product Designer (0→1)
